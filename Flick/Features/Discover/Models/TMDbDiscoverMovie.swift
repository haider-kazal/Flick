...
struct TMDbDiscoverMovie: Codable {
    ...
    init(from decoder: Decoder) throws {
        ...
        let backdropURL = URL(string: "\(Constants.TMDbConstants.thumbImageBaseURLString)\(backdropPath)")!
        ...
        let originalLanguage = try container.decode(String.self, forKey: .originalTitle)
        ...
        let posterURL = URL(string: "\(Constants.TMDbConstants.thumbImageBaseURLString)\(posterPath)")!
