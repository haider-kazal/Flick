...
final class MovieDetailsView: BaseView<DefaultMovieDetailsViewModel> {
    private let overviewCellReuseIdentifier = "\(MovieDetailsOverviewTableViewCell.self)"
    private let castsCellReuseIdentifier = "\(MovieDetailsCastsTableViewCell.self)"
    ...
    private(set) lazy var tableView: UITableView = {
        ...
        tableView.register(MovieDetailsOverviewTableViewCell.self, forCellReuseIdentifier: overviewCellReuseIdentifier)
        tableView.register(MovieDetailsCastsTableViewCell.self, forCellReuseIdentifier: castsCellReuseIdentifier)
        let headerView = MovieDetailsHeaderView(with: viewModel)
...
extension MovieDetailsView: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        switch cellSection {
        case .overview:
            let cell = tableView.dequeueReusableCell(withIdentifier: overviewCellReuseIdentifier, for: indexPath) as! MovieDetailsOverviewTableViewCell
            cell.configureWith(data: viewModel.briefDetails)
            return cell
            
        case .cast:
            let cell = tableView.dequeueReusableCell(withIdentifier: castsCellReuseIdentifier, for: indexPath) as! MovieDetailsCastsTableViewCell
...
private final class MovieDetailsHeaderView: BaseView<DefaultMovieDetailsViewModel> {
    ...
    override func setupViews() {
        ...
        viewModel.updateHeader = { [weak self] in
            self?.taglineLabel.text = self?.viewModel.details?.tagline
        }
    }
...
private final class MovieDetailsOverviewTableViewCell: BaseTableViewCell<TMDbDiscoverMovie> {
...
private final class MovieDetailsCastsTableViewCell: BaseTableViewCell<TMDbCast> {
